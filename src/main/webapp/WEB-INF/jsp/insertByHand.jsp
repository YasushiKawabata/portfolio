...
<body>
	...
	<div id="wrap">
		<h2>書籍新規登録</h2>
		<form action="/bookManager/Main?action=insertByHand" method="post">
			<dl>
				<dt><span class="required">タイトル</span></dt>
				<dd><input type="text" maxlength="50" size="50" name="title"></dd>
				<dt>著者</dt>
				<dd><input type="text" maxlength="20" size="40" name="author"></dd>
				<dt>出版社</dt>
				<dd><input type="text" maxlength="20" size="40" name="publisher"></dd>
				<dt>進捗状況</dt>
				<dd>
